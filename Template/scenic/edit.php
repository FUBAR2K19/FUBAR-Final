...
<link rel="stylesheet" href="css/tooplate-style.css">
      ...
      <form class="" action="scenic.inc.php" method="post" enctype="multipart/form-data">
...
<div class="navbar custom-navbar navbar-fixed-top" role="navigation">
     <div class="container">
          ...
          <div class="navbar-header">
               ...
               <!-- lOGO -->
            <h2>  <input name="StdName" placeholder="Studio Name">  </input> </h2>
          </div>
          ...
          <div class="collapse navbar-collapse">
               <ul class="nav navbar-nav navbar-right">
                    ...
                    <li><a href="#footer" class="smoothScroll">Let's talk</a></li>
               </ul>
          </div>
     ...
     <div class="container">
          <div class="row">
               ...
               <div class="col-md-8 col-sm-12">
                    <div class="home-text">
                         <h3>  <input name="TagLine" placeholder="Studio Tag Line" size="50">  </input> </h3>
          ...
          <div class="row">
               ...
               <div class="col-md-offset-1 col-md-10 col-sm-12">
                    <div class="about-info">
                        <h3>Introducing Studio Name
                        <h1><textarea name="intro" placeholder="Introduction"  cols="50"></textarea> </h1>
                    </div>
               </div>
          ...
          <div class="row">
               ...
               <div id="owl-team" class="owl-carousel">
                    <div class="col-md-4 col-sm-4 item">
                        ...
                        <p><input name="Emp1" placeholder="Employee Name"></input></p>
                         <h3><input name="post1" placeholder="Employee Post"></input></h3>
                    </div>
                   ...
                   <div class="col-md-4 col-sm-4 item">
                        ...
                        <p><input name="Emp2" placeholder="Employee Name"></input></p>
                         <h3><input name="post2" placeholder="Employee Post"></input></h3>
                    </div>
                    ...
                    <div class="col-md-4 col-sm-4 item">
                        ...
                        <p><input name="Emp3" placeholder="Employee Name"></input></p>
                         <h3><input name="post3" placeholder="Employee Post"></input></h3>
                    </div>
                    ...
                    <div class="col-md-4 col-sm-4 item">
                        ...
                        <p><input name="Emp4" placeholder="Employee Name"></input></p>
                         <h3><input name="post4" placeholder="Employee Post"></input></h3>
                    </div>
                    ...
                    <div class="col-md-4 col-sm-4 item">
                        ...
                        <p><input name="Emp5" placeholder="Employee Name"></input></p>
                         <h3><input name="post5" placeholder="Employee Post"></input></h3>
                    </div>
...
<!-- FOOTER -->
<footer>
    <section id="footer" class="parallax-section">
     <div class="container">
          <div class="row">

               <div class="col-md-5 col-sm-6">
                   Studio Name
                    <p><textarea name="add" placeholder="Physical Address" rows="3" cols="40"></textarea> </p>


               </div>

               <div style="float: right" class="col-md-4 col-sm-6">
                    <div class="footer-info">
                    	<h2>Keep in touch</h2>
                      Contact No.:
                         <p> <input type="text" name="contact" placeholder="Contact No."> </p>
                         Mail ID:
                         <p> <input type="text" name="Mail" placeholder="Mail"> </a></p>
               ...
               <div class="col-md-12 col-sm-12">
                    <div class="copyright-text">
                        <p>Copyright <input placeholder="Studio Name" name="copy"></input></p>
                        <br>
